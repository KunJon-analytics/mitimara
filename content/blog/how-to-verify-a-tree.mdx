---
title: "How to Verify Trees on MitiMara 🌱"
publishedAt: "2025-01-14"
image: "assets/og/blog/verify-tree.png"
summary: "Discover how to verify tree planting submissions on MitiMara, earn Pi tokens, and help maintain the integrity of our community-driven platform."
---
...
2. Ensure you have at least {minVerifierPoints} {siteName} [points](/blog/mitimara-dual-point-system) before verifying a tree. These points will be subtracted from your total points and returned only after the tree is completely verified and your submission aligns with the majority decision from other verifiers ({CUTOFF_VERIFICATIONS} out of {maxNoOfTreeVerifications}).
