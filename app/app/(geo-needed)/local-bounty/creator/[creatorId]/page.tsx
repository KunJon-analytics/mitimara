...
type CreatorHuntsPageParams = { params: Promise<{ creatorId: string }> };

export default async function CreatorHuntsPage({
  params,
}: CreatorHuntsPageParams) {
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-lg sm:text-2xl font-bold">Creator Bounty Hunts</h1>
        <Button asChild>
